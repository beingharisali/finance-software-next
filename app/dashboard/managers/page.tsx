...
// // import ProtectedRoute from "@/utilies/ProtectedRoute"; // <-- import karein
...
// //   return (
// //     <ProtectedRoute allowedRoles={["manager"]}> {/* sirf manager hi access */}
...
// //               <div className="activity-card"><div>Expense Approvals</div><div className="activity-value">3</div></div>
// //               <div className="activity-card"><div>Leave Requests</div><div className="activity-value">2</div></div>
// //               <div className="activity-card"><div>New Tasks</div><div className="activity-value">5</div></div>
// //             </div>
// //           </section>
// //         </main>
// //       </div>
...
// import { Chart, registerables } from "chart.js";
// import CreateUser from "../createusers/page"; 
// import ProtectedRoute from "@/utilies/ProtectedRoute"; // Role-based protection
...
//   const [showModal, setShowModal] = useState(false);  
//   const { user, logoutUser } = useAuthContext();
//   const [selectedRole, setSelectedRole] = useState<"agent" | "broker" | "manager" | "">("");

//   const handleOpenModal = (role: "agent" | "broker" | "manager") => {
//     setSelectedRole(role);
//     setShowModal(true);
//   };
...
//   return (
//     <ProtectedRoute allowedRoles={["manager"]}> {/* Manager only */}
//       <div className="dashboard-container">
//         {/* Sidebar */}
